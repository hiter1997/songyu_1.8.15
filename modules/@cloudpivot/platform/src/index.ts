...
import { IS_DEBUG, IS_DINGTALK, IS_IOS, IS_IE, IS_WECHAT, IS_WECHAT_PC_MAC, IS_WECHAT_PC_WINDOW } from './is-platform'
    ...
    if (IS_DEBUG) {
        ...
        if (IS_WECHAT) {
            ...
            if (IS_WECHAT_PC_MAC || IS_WECHAT_PC_WINDOW) {
                const wechat = await import(/* webpackChunkName: "dingtalk" */'./wechat');
