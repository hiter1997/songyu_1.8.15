    ...
    <div class="sheet-body-wrapper">
      ...
      >
        ...
        > 
            ...
            <template v-for="(rowItem,index) in tr[row.dataIndex]">
              <div :key="index" class="child-items-row">
                ...
                > 
                  ...
                  <!-- 关联表单 -->
                  <span v-else-if="item.propertyType === DataItemType.RelevanceForm">{{ rowItem[item.dataIndex] ? rowItem[item.dataIndex].data.name : '' }}</span>
          ...
          <!-- 关联表单 -->
          <div class="row-inner-wrapper" v-else-if="row.propertyType === DataItemType.RelevanceForm">{{ tr[row.dataIndex] ? tr[row.dataIndex].data.name : '' }}</div>
