...
<template>
  ...
  <!-- end----- 解决移动端附件上传导致的页面左右滚动 -->
    ...
    <h3-dialog v-transfer-dom v-model="showSignsture" class="dialog-demo" hide-on-blur>
      <div class="img-box">
        <iframe :src="filePreviewUrl" frameborder="0" width="100%" height="100%"></iframe>
      </div>
