        ...
        >
          ...
          >
            ...
            <table
              ...
              :style="`border-spacing: 0; border-collapse: collapse; padding: 0; max-width: 100%; overflow: hidden;height: ${pxToMM(
                item.heightValue
              )}mm;`"
            ...
            >
              <tr :style="` min-height: ${pxToMM(item.heightValue)}mm;`">
                ...
                >
                  <div
                    :style="`width: ${pxToMM(item.rightValue.widthValue -1)}mm; ${
                      item.ctrlType === 2 &&
            ...
            <div
              ...
              :style="`height: ${
                pxToMM(item.heightValue)
              }mm;width: ${pxToMM(item.widthValue)}mm;background: ${
                item.borderColorValue
              };`"
            ></div>
            <table
              ...
              background-color:${item.backgroundColor};max-width: 100%; border-collapse: collapse; 
              `"
              style="page-break-after: always"
              width="100%"
            >
              ...
              <tr
                ...
                :key="index"
                :style="`height:${pxToMM(item.bodyHeight)}mm`"
              >
                <td
