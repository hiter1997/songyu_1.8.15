...
export const borderDivs: object[] = [
  ...
  {
    key: "1px",
    ownStyle: "margin: 0 0 10px 0;",
    style: "width: 100%;height: 1px;background: #666",
    eleDom: ""
  },
  {
    key: "2px",
    ownStyle: "margin: 0 0 10px 0;",
    style: "width: 100%;height: 2px;background: #666",
    eleDom: ""
  },
  {
    key: "3px",
    ownStyle: "margin: 0 0 10px 0;",
    style: "width: 100%;height: 3px;background: #666",
    eleDom: ""
  },
  {
    key: "4px",
    ownStyle: "margin: 0 0 10px 0;",
    style: "width: 100%;height: 4px;background: #666",
    eleDom: ""
  },
  {
    key: "5px",
    ownStyle: "",
    style: "width: 100%;height: 5px;background: #666",
    eleDom: ""
  }
];
...
export const systemColumns: object[] = [
  {
    ...
    name: "摘要",
    code: "name",
    icon: "icon aufontAll h-icon-all-single-line-text"
  },
  {
    id: guid(),
    owner: "系统",
    ...
    name: "单据号",
    code: "sequenceNo",
    icon: "icon aufontAll h-icon-all-text-multiline"
  },
  {
    id: guid(),
    owner: "系统",
    ...
    name: "创建人",
    code: "creater",
    icon: "icon aufontAll h-icon-all-user-o"
  },
  {
    id: guid(),
    owner: "系统",
    ...
    name: "创建人部门",
    code: "createdDeptId",
    icon: "icon aufontAll h-icon-all-creator"
  },
  {
    id: guid(),
    owner: "系统",
    ...
    name: "所有人",
    code: "owner",
    icon: "icon aufontAll h-icon-all-user-list-o"
  },
  {
    id: guid(),
    owner: "系统",
    ...
    name: "所有人部门",
    code: "ownerDeptId",
    icon: "icon aufontAll h-icon-all-department-single-se"
  },
  {
    id: guid(),
    owner: "系统",
    ...
    name: "修改人",
    code: "modifier",
    icon: "icon aufontAll h-icon-all-user-modifier-o"
  },
  {
    id: guid(),
    owner: "系统",
    ...
    name: "创建时间",
    code: "createdTime",
    icon: "icon aufontAll h-icon-all-clock-circle-o"
  },
  {
    id: guid(),
    owner: "系统",
    ...
    name: "修改时间",
    code: "modifiedTime",
    icon: "icon aufontAll h-icon-all-clock-edit-o"
  }
];
...
export const iconTypes = [
  {
    ...
    name: "短文本",
    value: "测试文本",
    icon: "icon aufont icon-base-text-singleline-o"
  },
  {
    propertyType: 1,
    name: "长文本",
    value: "测试文本",
    icon: "icon aufont icon-base-text-multiline-o"
  },
  {
    propertyType: 2,
    name: "数值",
    value: "123",
    icon: "icon aufontAll h-icon-all-number"
  },
  {
    propertyType: 3,
    name: "日期",
    value: new Date().toLocaleDateString(),
    icon: "icon aufontAll h-icon-all-calendar-o"
  },
  {
    propertyType: 4,
    name: "逻辑",
    value: "是",
    icon: "icon aufontAll h-icon-all-logic-switch-o"
  },
  {
    propertyType: 5,
    name: "选人控件",
    value: "选人控件",
    icon: "icon aufont icon-base-adduser"
  },
  {
    propertyType: 6,
    name: "附件",
    value: "测试附件",
    icon: "icon aufontAll h-icon-all-paperclip-o"
  },
  {
    propertyType: 7,
    name: "审批意见",
    value: "测试文本",
    icon: "icon aufont icon-base-team-singlechoice-o"
  },
  {
    propertyType: 8,
    name: "子表",
    value: "表格测试文本",
    icon: "icon aufont icon-base-profile"
  },
  {
    propertyType: 9,
    name: "关联表单",
    value: "关联表单标题",
    icon: "icon aufont icon-base-form-related-o"
  },
  {
    propertyType: 10,
    name: "地理位置",
    value: "XX省 XX市XX县 XX街道",
    icon: "icon aufont icon-base-enviroment-o"
  },
  {
    propertyType: 100,
    name: "单据号",
  ...
  },
  {
    ...
    code: "name",
    type: "",
    value: `admin ${new Date().toLocaleDateString()}`
  }
];
