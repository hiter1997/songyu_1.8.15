      ...
      <div class="check-dingtalk__form">
        ...
        <a-row class="check-dingtalk__item">
          ...
          <a-col :span="layout.right" class="check-dingtalk__right">
            ...
            <a-input v-else v-model="params.appSecret" @change="saveParams" />
          </a-col>
        </a-row>
        ...
        <a-row class="check-dingtalk__item">
          ...
          <a-col :span="layout.right" class="check-dingtalk__right">
            ...
            <a-input v-else v-model="params.agentId" @change="saveParams" />
          </a-col>
        </a-row>
        ...
        <a-row class="check-dingtalk__item">
          ...
          <a-col :span="layout.right" class="check-dingtalk__right">
            ...
            <a-input v-else v-model="params.pcServerUrl" @change="saveParams" />
          </a-col>
        </a-row>
      </div>
    </div>
...
export default class CheckDingtalk extends Vue {
  ...
  mounted() {
    ...
    console.log(this.edit, "syncEdit");
  }
  // 初始化参数
  initParams() {
  ...
  saveParams() {
    ...
    // @ts-ignore
    let { appkey, appSecret, agentId, pcServerUrl } = this.params;
