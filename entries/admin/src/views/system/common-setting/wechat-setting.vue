      ...
      <div class="portal-setting__form">
        <a-row class="portal-setting__item">
          ...
          <a-col :span="layout.right" class="portal-setting__right">
            <span v-if="syncEdit" class="portal-setting__right--edit">
              {{
              params.corpId
              }}
            </span>
        ...
        <a-row class="portal-setting__item">
          ...
          <a-col :span="layout.right" class="portal-setting__right">
            <span v-if="edit" class="portal-setting__right--edit">
        ...
        <a-row class="portal-setting__item">
          ...
          <a-col :span="layout.right" class="portal-setting__right">
            <span class="portal-setting__right--edit">{{ params.synRedirectUri }}</span>
          </a-col>
        </a-row>
...
export default class WechatSetting extends Vue {
  ...
  initParams() {
    ...
    appSecret ? (this.params.appSecret = appSecret) : (this.params.appSecret = "");
    ...
    pcServerUrl ? (this.params.pcServerUrl = pcServerUrl) : (this.params.pcServerUrl = env.portalHost);
  ...
  saveDate() {
    ...
    let syncType = 0; // 同步方式 0 PULL 拉取 ,1 PUSH 推送
    ...
    // params.synRedirectUri = !params.synRedirectUri ? apiHost : params.synRedirectUri;
