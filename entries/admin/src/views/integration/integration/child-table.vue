<template>
  <div>
    ...
    >
      ...
      >{{ getHttpType(record.configs.httpType) }}</span>
      <span
        slot="url"
        v-if="service.isRestful"
        slot-scope="text, record"
      ...
      <span slot="action" slot-scope="text,record" class="child-table__actions">
        <template v-if="service.isRestful || service.isDatabase">
