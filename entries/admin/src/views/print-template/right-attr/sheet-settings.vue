  ...
  <div class="left-attr">
    ...
    <template v-if="itemAttrs.eleType">
      <div class="left-item">
        ...
        <a-input-number style="width:100%;margin-top:4px" v-model="itemAttrs.bodyHeight" @change="bodyHeightChange(itemAttrs.bodyHeight)" />
      </div>
...
export default class SheetSettings extends Vue {
  ...
  bodyHeightChange(height: number) {
    const diffH = height - (this.itemAttrs.heightValue - this.itemAttrs.headHeight - 31);
