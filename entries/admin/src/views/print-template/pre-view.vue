      ...
      <article>
        ...
        >
          <div>
            ...
            >
              <table :style="`height: ${item.heightValue}px;padding: 0; border-spacing: 0;border-collapse: collapse;display: block;` ">
                <tr
                  v-if="item.eleType.includes('column')"
                  :style="`height: ${item.heightValue -1}px;`"
                >
                  <td
                    :style="`
