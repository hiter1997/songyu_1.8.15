...
export default class MainDrawer extends Vue {
  ...
  onResize(
    ...
    // console.log(data,item,key,otherPartWidth,'otherPartWidth');
    ...
    if (part.widthValue < minWidth) {
      ...
      if (temp > this.maxWidth) {
        // console.log(this.maxWidth,item.left,otherPartWidth,'ddddd');
    ...
    if (item.eleType === "sheet") {
      if (part.widthValue !== widthCopy) {
        ...
        item.columns.forEach((col: any) => {
          col.widthValue = Math.floor((part.widthValue) * (col.widthValue / widthCopy));
    ...
    // console.log(part.widthValue,'part.widthValuepart.widthValue');
  ...
  getDrawerSize() {
    ...
    this.maxWidth =(paperSize.widthTopx - 2) - margin.LeftTopx - margin.RightTopx-30;
    this.maxHeight =
