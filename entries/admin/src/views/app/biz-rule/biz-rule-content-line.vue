  ...
  <div class="lines-wrap">
    ...
    <template v-for="(line,index) in lines">
      <div
        ...
        filter="url(#solid)"
        v-if="line.startActivity && line.startActivity.nodeType === 'LOGIC_VERIFY'"
      >
        <!-- :disabled="true" -->
        <a-select style="width: 64px" v-model="line.routeCondition" :disabled="true">
...
export default class LinesInstance extends Vue {
  ...
  endDragLine() {
    ...
    if ((this.operate.isStart || this.operate.isEnd) && this.operate.point && this.operate.point.Activity === undefined) {
      ...
      if (line && startActivity && startActivity.nodeType !== NodeType.LogicVerify) {
        this.resetLine();
      }
    ...
    } else if (line && startActivity && startActivity.nodeType === NodeType.LogicVerify) {
