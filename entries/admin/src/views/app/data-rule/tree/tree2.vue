<template>
  <div class="workflow-tree">
    ...
    <a-tree-select
      ...
      @search="onSearch"
      :dropdownStyle="{ maxHeight: '350px',height: '350px', maxWidth: width2+ 'px', overflow: 'auto' }"
...
export default class WorkflowTree extends Vue {
  ...
  width2 = 0;
  mounted() {
    this.width2 =  (this.$refs.treeSelect as any).$el.offsetWidth
   ...
   * 异步加载数据
   */
  async onTreeExpand(expandedKeys: string[]) {
    // debugger
    ...
    await this.loadAppChildren(key);
  }
