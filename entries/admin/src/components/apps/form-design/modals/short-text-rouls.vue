...
export default class CalculateRule extends Vue {
  ...
  dataItems: any[] = [];
  types:number[] = [FormControlType.Text, FormControlType.Dropdown,FormControlType.Date, FormControlType.Number, FormControlType.Radio, FormControlType.Checkbox, FormControlType.StaffSelector, FormControlType.StaffMultiSelector];
  selectDataItem: any = "";
  ruleHTML: any = ""
  ruleArr:IruleArr[] = []
  created() {
