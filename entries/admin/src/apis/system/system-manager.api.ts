...
export default {
   ...
   * @param params
   */
  checkEditPerm(params: BPM.System.GetManager)
    : Promise<Common.Res<void>> {
  ...
  createdappsManager(params: BPM.System.CreatedAppManagerParams)
    ...
    if (typeof params.dataManage !== 'undefined') arg.dataManage = params.dataManage; 
  ...
  getDataManage(params:Array<BPM.System.DataManageParams>):Promise<Common.Data>{
